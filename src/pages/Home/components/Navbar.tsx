...
import { useGetUserInfoQuery, useLoginMutation, useLogoutMutation } from "../../../redux/services/userApiSlice"
      ...
      >
        ...
        <div className="flex flex-col justify-between h-[calc(100%-60px)]">
          ...
          <div className="p-4 border-t border-white/20 text-white">
            {userInfo ? (
              <div className="text-sm">Signed in as <b>{userInfo.name}</b></div>
            ) : (
